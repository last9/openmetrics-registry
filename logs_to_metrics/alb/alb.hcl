ingester logs_to_metrics_alb module {
  ...
  gauge "status_3xx" {
    ...
    source prometheus "status_3xx" {
      query = "sum by (domain, uri, tag_service) (status_3xx{tag_service != '', tag_namespace = 'alb',  domain != '', uri != '', code != ''})"
    }
  }
  ...
  gauge "status_4xx" {
    ...
    source prometheus "status_4xx" {
      query = "sum by (domain, uri, tag_service) (status_4xx{tag_service != '', tag_namespace = 'alb',  domain != '', uri != '', code != ''})"
    }
  }
  ...
  gauge "status_5xx" {
    ...
    source prometheus "status_5xx" {
      query = "sum by (domain, uri, tag_service) (status_5xx{tag_service != '', tag_namespace = 'alb',  domain != '', uri != '', code != ''})"
    }
  }
